...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'os_communications.keepdb' => 'getOsCommunications_KeepdbService',
            'os_communications.launch' => 'getOsCommunications_LaunchService',
            'os_communications.messages.sender' => 'getOsCommunications_Messages_SenderService',
            'os_user.registration.form.type' => 'getOsUser_Registration_Form_TypeService',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\OS\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\OS\\GameBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'OS\\UserBundle\\Entity');
        $c->addDriver($b, 'OS\\GameBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('OSUserBundle' => 'OS\\UserBundle\\Entity', 'OSGameBundle' => 'OS\\GameBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_a21597ef0051f331c92ef31f49d24b858bc0ebd5fa972fe9054cad523dc62160');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('OS\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => '@FOSUser/Resetting/email.txt.twig', 'from_email' => array('confirmation' => array('monadresse@mail.fr' => 'monadresse@mail.fr'), 'resetting' => array('monadresse@mail.fr' => 'monadresse@mail.fr'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('OS\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'os_user_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('OS\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('OS\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('fos_user.util.password_updater'), $this->get('fos_user.util.canonical_fields_updater'), $this->get('doctrine')->getManager(NULL), 'OS\\UserBundle\\Entity\\User');
    }
    ...
    /*
     * Gets the public 'os_communications.keepdb' shared service.
     *
     * @return \OS\CommunicationsBundle\Service\DBKeeper
     */
    protected function getOsCommunications_KeepdbService()
    {
        return $this->services['os_communications.keepdb'] = new \OS\CommunicationsBundle\Service\DBKeeper($this->get('doctrine.orm.default_entity_manager'));
    }

    /*
     * Gets the public 'os_communications.launch' shared service.
     *
     * @return \OS\CommunicationsBundle\Service\Chat
     */
    protected function getOsCommunications_LaunchService()
    {
        return $this->services['os_communications.launch'] = new \OS\CommunicationsBundle\Service\Chat($this->get('doctrine.orm.default_entity_manager'), $this->get('os_communications.messages.sender'), $this->get('security.encoder_factory'));
    }

    /*
     * Gets the public 'os_communications.messages.sender' shared service.
     *
     * @return \OS\CommunicationsBundle\Service\MessagesSender
     */
    protected function getOsCommunications_Messages_SenderService()
    {
        return $this->services['os_communications.messages.sender'] = new \OS\CommunicationsBundle\Service\MessagesSender();
    }

    /*
     * Gets the public 'os_user.registration.form.type' shared service.
     *
     * @return \OS\UserBundle\Form\Type\RegistrationFormType
     */
    protected function getOsUser_Registration_Form_TypeService()
    {
        return $this->services['os_user.registration.form.type'] = new \OS\UserBundle\Form\Type\RegistrationFormType();
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt|error)|css|images|js)/'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'), 'security.firewall.map.context.default' => NULL)), $this->get('event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.in_memory'), 1 => $this->get('fos_user.user_provider.username')), 'main', $b, $c), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy'), $d, 'main', $h, $i, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5985d888af6a86.49488348', $b, $f), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/login', false), NULL, NULL, $b, false));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\OS\\UserBundle/Resources/views'), 'OSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\OS\\GameBundle/Resources/views'), 'OSGame');
        $instance->addPath(($this->targetDirs[3].'\\src\\OS\\CommunicationsBundle/Resources/views'), 'OSCommunications');
        $instance->addPath(($this->targetDirs[3].'\\src\\Core\\CoreBundle/Resources/views'), 'CoreCore');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('fos_user.user_provider.username'), $this->get('security.user_checker.main'), 'main', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5985d888af6a86.49488348'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5985d888af6a86.49488348')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'OSUserBundle' => 'OS\\UserBundle\\OSUserBundle',
                'OSGameBundle' => 'OS\\GameBundle\\OSGameBundle',
                'OSCommunicationsBundle' => 'OS\\CommunicationsBundle\\OSCommunicationsBundle',
                'CoreCoreBundle' => 'Core\\CoreBundle\\CoreCoreBundle',
            ),
            'kernel.bundles_metadata' => array(
                ...
                'OSUserBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\OS\\UserBundle'),
                    'namespace' => 'OS\\UserBundle',
                ),
                'OSGameBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\OS\\GameBundle'),
                    'namespace' => 'OS\\GameBundle',
                ),
                'OSCommunicationsBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\OS\\CommunicationsBundle'),
                    'namespace' => 'OS\\CommunicationsBundle',
                ),
                'CoreCoreBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Core\\CoreBundle'),
            ...
            'fos_user.model.user.class' => 'OS\\UserBundle\\Entity\\User',
            ...
            'fos_user.registration.form.type' => 'os_user_registration',
