...
class __TwigTemplate_16589e251498f167379816a67a94c116b8d8f70b60512e33cae34845ec69952c extends Twig_Template
{
    ...
    public function block_toolbar($context, array $blocks = array())
    {
        // line 6
        echo "    ";
        if (twig_get_attribute($this->env, $this->getSourceContext(), ($context["collector"] ?? null), "tokenClass", array())) {
            // line 7
            echo "        ";
    ...
    ";
        ...
        if (twig_get_attribute($this->env, $this->getSourceContext(), ($context["collector"] ?? null), "tokenClass", array())) {
            ...
            ";
            // line 30
            if ((twig_get_attribute($this->env, $this->getSourceContext(), ($context["collector"] ?? null), "tokenClass", array()) != null)) {
                // line 31
                echo "            <div class=\"sf-toolbar-info-piece\">
                <b>Token class</b>
                <span>";
            ...
            // line 36
            echo "            ";
            if (twig_get_attribute($this->env, $this->getSourceContext(), ($context["collector"] ?? null), "logoutUrl", array())) {
                // line 37
                echo "            <div class=\"sf-toolbar-info-piece\">
                <b>Actions</b>
                <span><a href=\"";
...
";
    ...
    public function block_menu($context, array $blocks = array())
    {
        ...
        echo ((( !twig_get_attribute($this->env, $this->getSourceContext(), ($context["collector"] ?? null), "enabled", array()) ||  !twig_get_attribute($this->env, $this->getSourceContext(), ($context["collector"] ?? null), "tokenClass", array()))) ? ("disabled") : (""));
        echo "\">
        <span class=\"icon\">";
        // line 58
        echo twig_include($this->env, $context, "@Security/Collector/icon.svg");
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ";
            // line 90
            echo twig_escape_filter($this->env, ((twig_test_empty(twig_get_attribute($this->env, $this->getSourceContext(), ($context["collector"] ?? null), "roles", array()))) ? ("none") : ($this->env->getExtension('Symfony\Bridge\Twig\Extension\YamlExtension')->encode(twig_get_attribute($this->env, $this->getSourceContext(), ($context["collector"] ?? null), "roles", array())))), "html", null, true);
            echo "
            ...
            if (twig_get_attribute($this->env, $this->getSourceContext(), ($context["collector"] ?? null), "supportsRoleHierarchy", array())) {
                ...
                echo "                <tr>
                    ...
                    <td>";
                // line 101
                echo twig_escape_filter($this->env, ((twig_test_empty(twig_get_attribute($this->env, $this->getSourceContext(), ($context["collector"] ?? null), "inheritedRoles", array()))) ? ("none") : ($this->env->getExtension('Symfony\Bridge\Twig\Extension\YamlExtension')->encode(twig_get_attribute($this->env, $this->getSourceContext(), ($context["collector"] ?? null), "inheritedRoles", array())))), "html", null, true);
                echo "</td>
                </tr>
                ";
            }
            ...
            if (twig_get_attribute($this->env, $this->getSourceContext(), ($context["collector"] ?? null), "tokenClass", array())) {
                ...
                echo "                <tr>
                    ...
                    <td>";
                // line 108
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->getSourceContext(), ($context["collector"] ?? null), "tokenClass", array()), "html", null, true);
                echo "</td>
                </tr>
                ";
            }
...
($context["collector"] ?? null), "enabled", array())) {
    ...
    {
        return new Twig_Source("", "SecurityBundle:Collector:security.html.twig", "D:\\Git\\os-server\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views/Collector/security.html.twig");
    }
}
