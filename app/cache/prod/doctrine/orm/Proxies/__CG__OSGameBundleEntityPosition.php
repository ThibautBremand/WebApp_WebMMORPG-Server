 ...
 */
class Position extends \OS\GameBundle\Entity\Position implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OS\\GameBundle\\Entity\\Position' . "\0" . 'id', '' . "\0" . 'OS\\GameBundle\\Entity\\Position' . "\0" . 'map', '' . "\0" . 'OS\\GameBundle\\Entity\\Position' . "\0" . 'x', '' . "\0" . 'OS\\GameBundle\\Entity\\Position' . "\0" . 'y'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Position $proxy) {
